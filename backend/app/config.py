...
class Settings(BaseSettings):
    ...
    ai_fallback_enabled: bool = Field(default=False, alias="AI_FALLBACK_ENABLED")
    ...
    ai_fallback_timeout_seconds: float = Field(default=45.0, alias="AI_FALLBACK_TIMEOUT_SECONDS")
    ...
    codex_turn_timeout_seconds: float = Field(default=300.0, alias="CODEX_TURN_TIMEOUT_SECONDS")

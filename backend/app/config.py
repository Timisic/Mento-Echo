...
class Settings(BaseSettings):
    ...
    ai_response_sla_seconds: float = Field(default=10.0, alias="AI_RESPONSE_SLA_SECONDS")
    ...
    ai_fallback_model_name: str = Field(default="deepseek-chat", alias="AI_FALLBACK_MODEL_NAME")
    ...
    ai_fallback_timeout_seconds: float = Field(default=10.0, alias="AI_FALLBACK_TIMEOUT_SECONDS")
    ...
    codex_command: str = Field(default="codex app-server", alias="CODEX_COMMAND")
    ...
    codex_turn_timeout_seconds: float = Field(default=10.0, alias="CODEX_TURN_TIMEOUT_SECONDS")
